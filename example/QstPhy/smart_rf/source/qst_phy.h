...
/*
    Task Initialization for the QST PHY Application
*/
extern void QstPhy_Init( uint8 task_id );

/*
    Task Event Processor for the QST PHY Application
*/
extern uint16 QstPhy_ProcessEvent( uint8 task_id, uint16 events );
